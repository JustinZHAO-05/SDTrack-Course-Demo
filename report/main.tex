...
\resizebox{\linewidth}{!}{\input{outputs/tables/sequence_visualization_manifest.tex}}
\end{table}
...
\resizebox{\linewidth}{!}{\input{outputs/tables/official_reproduction_comparison.tex}}
\end{table}
